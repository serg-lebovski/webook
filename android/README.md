...
Сервер должен быть доступен по сети с телефона. Для самоподписанного HTTPS-по-IP
(Caddy `tls internal`) сертификат не пройдёт проверку — используйте прямой HTTP-порт
