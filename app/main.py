...
from app.routers import auth, shelves, authors, series, books, opds, settings, links, admin, share, shared, dashboard, api, search, tags, highlights, feeds, pwa, audiobooks, tier_list, trash, manga, collections, stats, games
